    ...
    <div class="lot-item__content">
      <div class="lot-item__left">
        <div class="lot-item__image">
          <img src="img/<?= safeData($lotData['path']); ?>" width="730" height="548" alt="Сноуборд">
        </div>
        <p class="lot-item__category">Категория: <span><?= $lotData['category']; ?></span></p>
        <p class="lot-item__description"><?= $lotData['message']; ?></p>
      </div>
      <div class="lot-item__right">
        <div class="lot-item__state">
          <div class="lot-item__timer timer">
            <?= timeLeftShort($lotData['lot-date']); ?>
          </div>
          <div class="lot-item__cost-state">
            <div class="lot-item__rate">
              <span class="lot-item__amount">Текущая цена</span>
              <span class="lot-item__cost"><?= addRouble(safeData($lotData['lot-rate'])); ?></span>
            </div>
            <div class="lot-item__min-cost">
              Мин. ставка <span><?= addRouble(safeData($lotData['lot-rate']+$lotData['lot-step'])); ?></span>
            </div>
          </div>
          <form class="lot-item__form" action="https://echo.htmlacademy.ru" method="post">
            <p class="lot-item__form-item">
              <label for="cost">Ваша ставка</label>
              <input id="cost" type="number" name="cost" step="<?=$lotData['lot-step']?>" min="<?=$lotData['lot-rate']+$lotData['lot-step'] ?>" placeholder="<?= $lotData['lot-rate']+$lotData['lot-step']; ?>">
            </p>
